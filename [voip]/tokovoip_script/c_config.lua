TokoVoipConfig = {
	...
	wsServer = "185.141.207.151:3000", -- Address of the websocket server
	...
	plugin_data = {
		...
		TSChannel = "[TokoVoip] The City",
		TSPassword = "TOKOVOIP", -- TeamSpeak channel password (can be empty)
		...
		TSChannelWait = "[TokoVoip] Waiting Room",

		-- Blocking screen informations
		TSServer = "ts.nexusgta.com", -- TeamSpeak server address to be displayed on blocking screen
		...
		ClickVolume = -50, -- Set the radio clicks volume, -15 is a good default
