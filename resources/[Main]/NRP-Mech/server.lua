...
AddEventHandler('xz-mech:onduty',function()
    ...
    TriggerEvent('core:getPlayerFromId', source, function(user)
        user.setJob(3)
        TriggerClientEvent('NRP-notify:client:SendAlert', source, { type = 'success', text = "You are now On Duty", timeout= 10000})
    end)
end)
...
AddEventHandler('xz-mech:offduty',function()
    ...
    TriggerEvent('core:getPlayerFromId', source, function(user)
        user.setJob(38)
        TriggerClientEvent('NRP-notify:client:SendAlert', source, { type = 'error', text = "You are now Off Duty", timeout= 10000})
    end)
end)
