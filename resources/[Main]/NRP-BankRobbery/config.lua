...
Banks = {
	--[[["fleeca"] = {
		position = { ['x'] = 148.91908752441, ['y'] = -1050.7448242188, ['z'] = 29.36802482605 },
      -- position of robbery, when you have tu use the item "blowtorch"
		...
		reward = math.random(1500,2500), -- the random range of amount of money you will get for robbery this site
	...
	["PrincipalBank"] = {
		position = { ['x'] = 252.5543291992, ['y'] = 221.2957227, ['z'] = 101.68346405029 },
		hackposition = { ['x'] = 262.38388, ['y'] = 223.07241, ['z'] = 106.28445029 },
        bombposition = { ['x'] = 253.12199291992, ['y'] = 224.28176782227, ['z'] = 101.87346405029 }, -- if this var is set will appear a site to plant a bomb which will open the door defined at var "bombdoortype"
