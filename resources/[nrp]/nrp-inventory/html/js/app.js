...
function showBlur() {
    $.post('https://nrp-inventory/showBlur');
}
...
function FormatAttachmentInfo(data) {
    $.post(
        "https://nrp-inventory/GetWeaponData",
        JSON.stringify({
            weapon: data.name,
...
function handleAttachmentDrag() {
    ...
    $(".weapon-attachments-remove").droppable({
        ...
        drop: function(event, ui) {
            $.post(
                "https://nrp-inventory/RemoveAttachment",
                JSON.stringify({
...
$(document).on("click", ".CombineItem", function(e) {
    ...
    if (combineslotData.toData.combinable.anim != null) {
        $.post(
            "https://nrp-inventory/combineWithAnim",
            JSON.stringify({
        ...
        $.post(
            "https://nrp-inventory/combineItem",
            JSON.stringify({
...
function optionSwitch(
    ...
    $.post(
        "https://nrp-inventory/SetInventoryData",
        JSON.stringify({
...
function swap($fromSlot, $toSlot, $fromInv, $toInv, $toAmount) {
    ...
    if (fromData !== undefined && fromData.amount >= $toAmount) {
        ...
        if (
            ...
            $.post("https://nrp-inventory/PlayDropSound", JSON.stringify({}));
            $.post(
                "https://nrp-inventory/SetInventoryData",
                JSON.stringify({
                    fromInventory: $fromInv.attr("data-inventory"),
            ...
            if (fromData.amount == $toAmount) {
                if (
                    ...
                    $.post(
                        "https://nrp-inventory/getCombineItem",
...
function InventoryError($elinv, $elslot) {
    ...
    $.post("https://nrp-inventory/PlayDropFail", JSON.stringify({}));
}
...
(() => {
    ...
    Inventory.Close = function() {
        ...
        $.post("https://nrp-inventory/CloseInventory", JSON.stringify({}));
