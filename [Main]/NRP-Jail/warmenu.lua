...
local function drawTitle()
    if menus[currentMenu] then
        ...
        elseif menus[currentMenu].background == "gunstore1" then
            RequestStreamedTextureDict("shopui_title_gunclub")
            DrawSprite("shopui_title_gunclub", "shopui_title_gunclub", x, y, menuWidth, titleHeight, 0.0, 255, 255, 255, 255)
...
function WarMenu.CreateMenu(id, background,title)
    ...
    menus[id].background = background
