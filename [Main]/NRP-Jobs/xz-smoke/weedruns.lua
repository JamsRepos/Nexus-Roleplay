...
function XzText(x,y,z,text,size)
...
Citizen.CreateThread(function()
	while true do
		...
		cooldown = math.random(60000,180000)
		Citizen.Wait(cooldown) 
		TriggerEvent('InteractSound_CL:PlayOnOne', 'pager', 0.4)
		exports['NRP-notify']:DoHudText('success', 'New Delivery GPS Updated')
		hasdelivery = true
...
function rewarduber()
 ...
 local pay = math.random(350, 450)
 TriggerServerEvent('FL_Perks:LevelChecks')
 Wait(300)
 if tostring(job) == 'SOTW' then
	if tonumber(points) >= 750 then
		if result == 1 then
			TriggerEvent("inventory:removeQty", 298, result)
			TriggerServerEvent('jobs:paytheplayer', pay, 'SOTW: Medical Weed')
			exports['NRP-notify']:DoHudText('success', 'You delivered '..result..' bag of medical weed')
			removeblips()
			hasdelivery = false
			disablepressE = false
			disablepressH = false
		...
		elseif result == 2 then
			TriggerEvent("inventory:removeQty", 298,result)
			TriggerServerEvent('jobs:paytheplayer', pay*2, 'SOTW: Medical Weed')
			exports['NRP-notify']:DoHudText('success', 'You delivered '..result..' bags of medical weed')
			removeblips()
			hasdelivery = false
			disablepressE = false
			disablepressH = false
			...
			TriggerEvent("inventory:removeQty", 298,result)
			TriggerServerEvent('jobs:paytheplayer', pay*3, 'SOTW: Medical Weed')
			exports['NRP-notify']:DoHudText('success', 'You delivered '..result..' bags of medical weed')
			removeblips()
			hasdelivery = false
			disablepressE = false
	...
	elseif tonumber(points) >= 250 then						
		TriggerEvent("inventory:removeQty", 298,1)
		TriggerServerEvent('jobs:paytheplayer', pay, 'SOTW: Medical Weed')
		removeblips()
		hasdelivery = false
		disablepressE = false
...
Citizen.CreateThread(function ()
	while true do
		Citizen.Wait(0)
		if starteduber then
		    if exports['core']:GetItemQuantity(298) >= 10 then 
			--[[ Door 1 ]]
			if GetDistanceBetweenCoords(GetEntityCoords(GetPlayerPed(-1)), DeliveryLocations[1]["x"], DeliveryLocations[1]["y"], DeliveryLocations[1]["z"], true ) < 1.8 and deliverydoor1 and hasdelivery then --and PlayerData.job ~= nil and PlayerData.job.name == 'mecano'
					if doorknocked1 == false and GetDistanceBetweenCoords(GetEntityCoords(GetPlayerPed(-1)), DeliveryLocations[1]["x"], DeliveryLocations[1]["y"], DeliveryLocations[1]["z"], true ) < 1.8 then
					 XzText(DeliveryLocations[1]["x"], DeliveryLocations[1]["y"], DeliveryLocations[1]["z"] + 0.3, tostring("~w~~g~[E]~w~ Knock on Door"))
					end 
					...
					if(IsControlJustPressed(1, Keys["E"])) and not deliveryporch1 and not disablepressE then
						...
						if ispedhomechance == 1 then							 
							...
							droppingpackage = true
					 		Citizen.Wait(0)
					 		exports["xz_progbar"]:StartDelayedFunction("Giving Package...", math.random(5000,10000), function()
				...
				if GetDistanceBetweenCoords(GetEntityCoords(GetPlayerPed(-1)), DeliveryLocations[1]["x2"], DeliveryLocations[1]["y2"], DeliveryLocations[1]["z2"], true ) < 4.0 and deliveryporch1 and hasdelivery then
					XzText(DeliveryLocations[1]["x2"], DeliveryLocations[1]["y2"], DeliveryLocations[1]["z2"] + 0.3, tostring("~g~[H]~w~ Leave Package"))
				 if(IsControlJustPressed(1, Keys["H"])) and not disablepressH then
					...
					local plyPos = GetEntityCoords(plyPed, false) ---- --240.05, -1168.83, 22.98
				 	...
				 	TaskStartScenarioInPlace(PlayerPedId(), "PROP_HUMAN_BUM_BIN", 0, true) -- Because IT FITSSSSSSS - 99kr
					 		Citizen.Wait(0)
					 		exports["xz_progbar"]:StartDelayedFunction("Leaving Package...", math.random(5000,10000), function()
							ClearPedTasks(PlayerPedId())
							ClearPedTasks(PlayerPedId(-1))
			...
			--[[ Door 2 ]]
							if GetDistanceBetweenCoords(GetEntityCoords(GetPlayerPed(-1)), DeliveryLocations[2]["x"], DeliveryLocations[2]["y"], DeliveryLocations[2]["z"], true ) < 1.8 and deliverydoor2 and hasdelivery then --and PlayerData.job ~= nil and PlayerData.job.name == 'mecano'
					if doorknocked2 == false and GetDistanceBetweenCoords(GetEntityCoords(GetPlayerPed(-1)), DeliveryLocations[2]["x"], DeliveryLocations[2]["y"], DeliveryLocations[2]["z"], true ) < 1.8 then
					 XzText(DeliveryLocations[2]["x"], DeliveryLocations[2]["y"], DeliveryLocations[2]["z"] + 0.3, tostring("~w~~g~[E]~w~ Knock on Door"))
					end 
				...
				if GetDistanceBetweenCoords(GetEntityCoords(GetPlayerPed(-1)), DeliveryLocations[2]["x2"], DeliveryLocations[2]["y2"], DeliveryLocations[2]["z2"], true ) < 4.0 and deliveryporch2 == true and hasdelivery then
					XzText(DeliveryLocations[2]["x2"], DeliveryLocations[2]["y2"], DeliveryLocations[2]["z2"] + 0.3, tostring("~w~~g~[H]~w~ Leave Package"))
			...
			--[[ Door 3 ]]
				if GetDistanceBetweenCoords(GetEntityCoords(GetPlayerPed(-1)), DeliveryLocations[3]["x"], DeliveryLocations[3]["y"], DeliveryLocations[3]["z"], true ) < 1.8 and deliverydoor3 and hasdelivery then --and PlayerData.job ~= nil and PlayerData.job.name == 'mecano'
					if doorknocked3 == false and GetDistanceBetweenCoords(GetEntityCoords(GetPlayerPed(-1)), DeliveryLocations[3]["x"], DeliveryLocations[3]["y"], DeliveryLocations[3]["z"], true ) < 1.8 then
					 XzText(DeliveryLocations[3]["x"], DeliveryLocations[3]["y"], DeliveryLocations[3]["z"] + 0.3, tostring("~w~~g~[E]~w~ Knock on Door"))
					end 
				...
				if GetDistanceBetweenCoords(GetEntityCoords(GetPlayerPed(-1)), DeliveryLocations[3]["x2"], DeliveryLocations[3]["y2"], DeliveryLocations[3]["z2"], true ) < 4.0 and deliveryporch3 and hasdelivery then
					XzText(DeliveryLocations[3]["x2"], DeliveryLocations[3]["y2"], DeliveryLocations[3]["z2"] + 0.3, tostring("~w~~g~[H]~w~ Leave Package"))
				 if(IsControlJustPressed(1, Keys["H"])) and not disablepressH then -- and PlayerData.job ~= nil and PlayerData.job.name == 'mecano'
				 	local player = PlayerId()
					local plyPed = GetPlayerPed(player)
					local plyPos = GetEntityCoords(plyPed, false) ---- --240.05, -1168.83, 22.98
			...
			--[[ Door 4 ]]
				if GetDistanceBetweenCoords(GetEntityCoords(GetPlayerPed(-1)), DeliveryLocations[4]["x"], DeliveryLocations[4]["y"], DeliveryLocations[4]["z"], true ) < 1.8 and deliverydoor4 and hasdelivery then --and PlayerData.job ~= nil and PlayerData.job.name == 'mecano'
					if doorknocked4 == false and GetDistanceBetweenCoords(GetEntityCoords(GetPlayerPed(-1)), DeliveryLocations[4]["x"], DeliveryLocations[4]["y"], DeliveryLocations[4]["z"], true ) < 1.8 then
					 XzText(DeliveryLocations[4]["x"], DeliveryLocations[4]["y"], DeliveryLocations[4]["z"] + 0.3, tostring("~w~~g~[E]~w~ Knock on Door"))
					end 
				...
				if GetDistanceBetweenCoords(GetEntityCoords(GetPlayerPed(-1)), DeliveryLocations[4]["x2"], DeliveryLocations[4]["y2"], DeliveryLocations[4]["z2"], true ) < 4.0 and deliveryporch4 == true and hasdelivery then
					XzText(DeliveryLocations[4]["x"], DeliveryLocations[4]["y"], DeliveryLocations[4]["z"] + 0.3, tostring("~w~~g~[H]~w~ Leave Package"))
				 if(IsControlJustPressed(1, Keys["H"])) and not disablepressH then -- and PlayerData.job ~= nil and PlayerData.job.name == 'mecano'
			...
			--[[ Door 5 ]]
				if GetDistanceBetweenCoords(GetEntityCoords(GetPlayerPed(-1)), DeliveryLocations[5]["x"], DeliveryLocations[5]["y"], DeliveryLocations[5]["z"], true ) < 1.8 and deliverydoor5 and hasdelivery then --and PlayerData.job ~= nil and PlayerData.job.name == 'mecano'
					if doorknocked5 == false and GetDistanceBetweenCoords(GetEntityCoords(GetPlayerPed(-1)), DeliveryLocations[5]["x"], DeliveryLocations[5]["y"], DeliveryLocations[5]["z"], true ) < 1.8 then
					 XzText(DeliveryLocations[5]["x"], DeliveryLocations[5]["y"], DeliveryLocations[5]["z"] + 0.3, tostring("~w~~g~[E]~w~ Knock on Door"))
					end 
				...
				if GetDistanceBetweenCoords(GetEntityCoords(GetPlayerPed(-1)), DeliveryLocations[5]["x2"], DeliveryLocations[5]["y2"], DeliveryLocations[5]["z2"], true ) < 4.0 and deliveryporch5 and hasdelivery then
					XzText(DeliveryLocations[5]["x2"], DeliveryLocations[5]["y2"], DeliveryLocations[5]["z2"] + 0.3, tostring("~w~~g~[H]~w~ Leave Package"))
				 if(IsControlJustPressed(1, Keys["H"])) and not disablepressH then -- and PlayerData.job ~= nil and PlayerData.job.name == 'mecano'
				 	local player = PlayerId()
					local plyPed = GetPlayerPed(player)
					local plyPos = GetEntityCoords(plyPed, false) ---- --240.05, -1168.83, 22.98
			...
			--[[ Door 6 ]]
				if GetDistanceBetweenCoords(GetEntityCoords(GetPlayerPed(-1)), DeliveryLocations[6]["x"], DeliveryLocations[6]["y"], DeliveryLocations[6]["z"], true ) < 1.8 and deliverydoor6 and hasdelivery then --and PlayerData.job ~= nil and PlayerData.job.name == 'mecano'
					if doorknocked6 == false and GetDistanceBetweenCoords(GetEntityCoords(GetPlayerPed(-1)), DeliveryLocations[6]["x"], DeliveryLocations[6]["y"], DeliveryLocations[6]["z"], true ) < 1.8 then
					 XzText(DeliveryLocations[6]["x"], DeliveryLocations[6]["y"], DeliveryLocations[6]["z"] + 0.3, tostring("~w~~g~[E]~w~ Knock on Door"))
					end 
				...
				if GetDistanceBetweenCoords(GetEntityCoords(GetPlayerPed(-1)), DeliveryLocations[6]["x2"], DeliveryLocations[6]["y2"], DeliveryLocations[6]["z2"], true ) < 4.0 and deliveryporch6 and hasdelivery then
					XzText(DeliveryLocations[6]["x2"], DeliveryLocations[6]["y2"], DeliveryLocations[6]["z2"] + 0.3, tostring("~w~~g~[H]~w~ Leave Package"))
				 if(IsControlJustPressed(1, Keys["H"])) and not disablepressH then -- and PlayerData.job ~= nil and PlayerData.job.name == 'mecano'
				 	local player = PlayerId()
					local plyPed = GetPlayerPed(player)
					local plyPos = GetEntityCoords(plyPed, false) ---- --240.05, -1168.83, 22.98
			...
			--[[ Door 7 ]]
					if GetDistanceBetweenCoords(GetEntityCoords(GetPlayerPed(-1)), DeliveryLocations[7]["x"], DeliveryLocations[7]["y"], DeliveryLocations[7]["z"], true ) < 1.8 and deliverydoor7 and hasdelivery then --and PlayerData.job ~= nil and PlayerData.job.name == 'mecano'
					if doorknocked7 == false and GetDistanceBetweenCoords(GetEntityCoords(GetPlayerPed(-1)), DeliveryLocations[7]["x"], DeliveryLocations[7]["y"], DeliveryLocations[7]["z"], true ) < 1.8 then
					 XzText(DeliveryLocations[7]["x"], DeliveryLocations[7]["y"], DeliveryLocations[7]["z"] + 0.3, tostring("~w~~g~[E]~w~ Knock on Door"))
					end 
				...
				if GetDistanceBetweenCoords(GetEntityCoords(GetPlayerPed(-1)), DeliveryLocations[7]["x2"], DeliveryLocations[7]["y2"], DeliveryLocations[7]["z2"], true ) < 4.0 and deliveryporch7 and hasdelivery then
					XzText(DeliveryLocations[7]["x2"], DeliveryLocations[7]["y2"], DeliveryLocations[7]["z2"] + 0.3, tostring("~w~~g~[H]~w~ Leave Package"))
				 if(IsControlJustPressed(1, Keys["H"])) and not disablepressH then -- and PlayerData.job ~= nil and PlayerData.job.name == 'mecano'
				 	local player = PlayerId()
					local plyPed = GetPlayerPed(player)
					local plyPos = GetEntityCoords(plyPed, false) ---- --240.05, -1168.83, 22.98
			...
			--[[ Door 8 ]]
					if GetDistanceBetweenCoords(GetEntityCoords(GetPlayerPed(-1)), DeliveryLocations[8]["x"], DeliveryLocations[8]["y"], DeliveryLocations[8]["z"], true ) < 1.8 and deliverydoor8 and hasdelivery then --and PlayerData.job ~= nil and PlayerData.job.name == 'mecano'
					if doorknocked8 == false and GetDistanceBetweenCoords(GetEntityCoords(GetPlayerPed(-1)), DeliveryLocations[8]["x"], DeliveryLocations[8]["y"], DeliveryLocations[8]["z"], true ) < 1.8 then
					 XzText(DeliveryLocations[8]["x"], DeliveryLocations[8]["y"], DeliveryLocations[8]["z"] + 0.3, tostring("~w~~g~[E]~w~ Knock on Door"))
					end 
				...
				if GetDistanceBetweenCoords(GetEntityCoords(GetPlayerPed(-1)), DeliveryLocations[8]["x2"], DeliveryLocations[8]["y2"], DeliveryLocations[8]["z2"], true ) < 4.0 and deliveryporch8 and hasdelivery then
					XzText(DeliveryLocations[8]["x2"], DeliveryLocations[8]["y2"], DeliveryLocations[8]["z2"] + 0.3, tostring("~w~~g~[H]~w~ Leave Package"))
				 if(IsControlJustPressed(1, Keys["H"])) and not disablepressH then -- and PlayerData.job ~= nil and PlayerData.job.name == 'mecano'
				 	local player = PlayerId()
					local plyPed = GetPlayerPed(player)
					local plyPos = GetEntityCoords(plyPed, false) ---- --240.05, -1168.83, 22.98
			...
			--[[ Door 9 ]]
				if GetDistanceBetweenCoords(GetEntityCoords(GetPlayerPed(-1)), DeliveryLocations[9]["x"], DeliveryLocations[9]["y"], DeliveryLocations[9]["z"], true ) < 1.8 and deliverydoor9 and hasdelivery then --and PlayerData.job ~= nil and PlayerData.job.name == 'mecano'
					if doorknocked9 == false and GetDistanceBetweenCoords(GetEntityCoords(GetPlayerPed(-1)), DeliveryLocations[9]["x"], DeliveryLocations[9]["y"], DeliveryLocations[9]["z"], true ) < 1.8 then
					 XzText(DeliveryLocations[9]["x"], DeliveryLocations[9]["y"], DeliveryLocations[9]["z"] + 0.3, tostring("~w~~g~[E]~w~ Knock on Door"))
					end 
				...
				if GetDistanceBetweenCoords(GetEntityCoords(GetPlayerPed(-1)), DeliveryLocations[9]["x2"], DeliveryLocations[9]["y2"], DeliveryLocations[9]["z2"], true ) < 4.0 and deliveryporch9 and hasdelivery then
					XzText(DeliveryLocations[9]["x2"], DeliveryLocations[9]["y2"], DeliveryLocations[9]["z2"] + 0.3, tostring("~w~~g~[H]~w~ Leave Package"))
				 if(IsControlJustPressed(1, Keys["H"])) and not disablepressH then -- and PlayerData.job ~= nil and PlayerData.job.name == 'mecano'
				 	local player = PlayerId()
					local plyPed = GetPlayerPed(player)
					local plyPos = GetEntityCoords(plyPed, false) ---- --240.05, -1168.83, 22.98
			...
			--[[ Door 10 ]]
			if GetDistanceBetweenCoords(GetEntityCoords(GetPlayerPed(-1)), DeliveryLocations[10]["x"], DeliveryLocations[10]["y"], DeliveryLocations[10]["z"], true ) < 1.8 and deliverydoor10 and hasdelivery then --and PlayerData.job ~= nil and PlayerData.job.name == 'mecano'
					if doorknocked10 == false and GetDistanceBetweenCoords(GetEntityCoords(GetPlayerPed(-1)), DeliveryLocations[10]["x"], DeliveryLocations[10]["y"], DeliveryLocations[10]["z"], true ) < 1.8 then
					 XzText(DeliveryLocations[10]["x"], DeliveryLocations[10]["y"], DeliveryLocations[10]["z"] + 0.3, tostring("~w~~g~[E]~w~ Knock on Door"))
					end 
				...
				if GetDistanceBetweenCoords(GetEntityCoords(GetPlayerPed(-1)), DeliveryLocations[10]["x2"], DeliveryLocations[10]["y2"], DeliveryLocations[10]["z2"], true ) < 4.0 and deliveryporch10 and hasdelivery then
					XzText(DeliveryLocations[10]["x2"], DeliveryLocations[10]["y2"], DeliveryLocations[10]["z2"] + 0.3, tostring("~w~~g~[H]~w~ Leave Package"))
				 if(IsControlJustPressed(1, Keys["H"])) and not disablepressH then -- and PlayerData.job ~= nil and PlayerData.job.name == 'mecano'
				 	local player = PlayerId()
					local plyPed = GetPlayerPed(player)
					local plyPos = GetEntityCoords(plyPed, false) ---- --240.05, -1168.83, 22.98
			...
			--[[ Door 11 ]]
			if GetDistanceBetweenCoords(GetEntityCoords(GetPlayerPed(-1)), DeliveryLocations[11]["x"], DeliveryLocations[11]["y"], DeliveryLocations[11]["z"], true ) < 1.8 and deliverydoor11 and hasdelivery then --and PlayerData.job ~= nil and PlayerData.job.name == 'mecano'
					if doorknocked11 == false and GetDistanceBetweenCoords(GetEntityCoords(GetPlayerPed(-1)), DeliveryLocations[11]["x"], DeliveryLocations[11]["y"], DeliveryLocations[11]["z"], true ) < 1.8 then
					 XzText(DeliveryLocations[11]["x"], DeliveryLocations[11]["y"], DeliveryLocations[11]["z"] + 0.3, tostring("~w~~g~[E]~w~ Knock on Door"))
					end 
				...
				if GetDistanceBetweenCoords(GetEntityCoords(GetPlayerPed(-1)), DeliveryLocations[11]["x2"], DeliveryLocations[11]["y2"], DeliveryLocations[11]["z2"], true ) < 4.0 and deliveryporch11 and hasdelivery then
					XzText(DeliveryLocations[11]["x2"], DeliveryLocations[11]["y2"], DeliveryLocations[11]["z2"] + 0.3, tostring("~w~~g~[H]~w~ Leave Package"))
				 if(IsControlJustPressed(1, Keys["H"])) and not disablepressH then -- and PlayerData.job ~= nil and PlayerData.job.name == 'mecano'
				 	local player = PlayerId()
					local plyPed = GetPlayerPed(player)
					local plyPos = GetEntityCoords(plyPed, false) ---- --240.05, -1168.83, 22.98
				 	...
				 	TaskStartScenarioInPlace(PlayerPedId(), "PROP_HUMAN_BUM_BIN", 0, true) -- Because IT FITSSSSSSS - 99kr
						...
						--[[ Door 12 ]]
			if GetDistanceBetweenCoords(GetEntityCoords(GetPlayerPed(-1)), DeliveryLocations[12]["x"], DeliveryLocations[12]["y"], DeliveryLocations[12]["z"], true ) < 1.8 and deliverydoor12 and hasdelivery then --and PlayerData.job ~= nil and PlayerData.job.name == 'mecano'
					if doorknocked12 == false and GetDistanceBetweenCoords(GetEntityCoords(GetPlayerPed(-1)), DeliveryLocations[12]["x"], DeliveryLocations[12]["y"], DeliveryLocations[12]["z"], true ) < 1.8 then
					 XzText(DeliveryLocations[12]["x"], DeliveryLocations[12]["y"], DeliveryLocations[12]["z"] + 0.3, tostring("~w~~g~[E]~w~ Knock on Door"))
					end 
				...
				if GetDistanceBetweenCoords(GetEntityCoords(GetPlayerPed(-1)), DeliveryLocations[12]["x2"], DeliveryLocations[12]["y2"], DeliveryLocations[12]["z2"], true ) < 4.0 and deliveryporch12 and hasdelivery then
					XzText(DeliveryLocations[12]["x2"], DeliveryLocations[12]["y2"], DeliveryLocations[12]["z2"] + 0.3, tostring("~w~~g~[H]~w~ Leave Package"))
				 if(IsControlJustPressed(1, Keys["H"])) and not disablepressH then -- and PlayerData.job ~= nil and PlayerData.job.name == 'mecano'
				 	local player = PlayerId()
					local plyPed = GetPlayerPed(player)
					local plyPos = GetEntityCoords(plyPed, false) ---- --240.05, -1168.83, 22.98
			...
			---
									--[[ Door 13 ]]
			if GetDistanceBetweenCoords(GetEntityCoords(GetPlayerPed(-1)), DeliveryLocations[13]["x"], DeliveryLocations[13]["y"], DeliveryLocations[13]["z"], true ) < 1.8 and deliverydoor13 and hasdelivery then --and PlayerData.job ~= nil and PlayerData.job.name == 'mecano'
					if doorknocked13 == false and GetDistanceBetweenCoords(GetEntityCoords(GetPlayerPed(-1)), DeliveryLocations[13]["x"], DeliveryLocations[13]["y"], DeliveryLocations[13]["z"], true ) < 1.8 then
					 XzText(DeliveryLocations[13]["x"], DeliveryLocations[13]["y"], DeliveryLocations[13]["z"] + 0.3, tostring("~w~~g~[E]~w~ Knock on Door"))
					end 
				...
				if GetDistanceBetweenCoords(GetEntityCoords(GetPlayerPed(-1)), DeliveryLocations[13]["x2"], DeliveryLocations[13]["y2"], DeliveryLocations[13]["z2"], true ) < 4.0 and deliveryporch13 and hasdelivery then
					XzText(DeliveryLocations[13]["x2"], DeliveryLocations[13]["y2"], DeliveryLocations[13]["z2"] + 0.3, tostring("~w~~g~[H]~w~ Leave Package"))
				 if(IsControlJustPressed(1, Keys["H"])) and not disablepressH then -- and PlayerData.job ~= nil and PlayerData.job.name == 'mecano'
				 	local player = PlayerId()
					local plyPed = GetPlayerPed(player)
					local plyPos = GetEntityCoords(plyPed, false) ---- --240.05, -1168.83, 22.98
			...
			---
									--[[ Door 14 ]]
			if GetDistanceBetweenCoords(GetEntityCoords(GetPlayerPed(-1)), DeliveryLocations[14]["x"], DeliveryLocations[14]["y"], DeliveryLocations[14]["z"], true ) < 1.8 and deliverydoor14 and hasdelivery then --and PlayerData.job ~= nil and PlayerData.job.name == 'mecano'
					if doorknocked14 == false and GetDistanceBetweenCoords(GetEntityCoords(GetPlayerPed(-1)), DeliveryLocations[14]["x"], DeliveryLocations[14]["y"], DeliveryLocations[14]["z"], true ) < 1.8 then
					 XzText(DeliveryLocations[14]["x"], DeliveryLocations[14]["y"], DeliveryLocations[14]["z"] + 0.3, tostring("~w~~g~[E]~w~ Knock on Door"))
					end 
				...
				if GetDistanceBetweenCoords(GetEntityCoords(GetPlayerPed(-1)), DeliveryLocations[14]["x2"], DeliveryLocations[14]["y2"], DeliveryLocations[14]["z2"], true ) < 4.0 and deliveryporch14 and hasdelivery then
					XzText(DeliveryLocations[14]["x2"], DeliveryLocations[14]["y2"], DeliveryLocations[14]["z2"] + 0.3, tostring("~w~~g~[H]~w~ Leave Package"))
				 if(IsControlJustPressed(1, Keys["H"])) and not disablepressH then -- and PlayerData.job ~= nil and PlayerData.job.name == 'mecano'
				 	local player = PlayerId()
					local plyPed = GetPlayerPed(player)
					local plyPos = GetEntityCoords(plyPed, false) ---- --240.05, -1168.83, 22.98
...
RegisterCommand('drops', function(source, args, rawCommand)
	TriggerServerEvent('FL_Perks:LevelChecks')
	Wait(100)
 if tostring(job) == 'SOTW' then
  if tonumber(points) >= 250 then
   if exports['core']:GetItemQuantity(298) >= 10 then --- change this
    if not starteduber and uberdeliveryamount ~= 10 then
	 exports['NRP-notify']:DoHudText('success', 'Smoke on the water Delivery: Active [Wait for Delivery]')
	 starteduber = true
	 hasdelivery = false
	elseif starteduber then
	 exports['NRP-notify']:DoHudText('error', 'Smoke on the water Delivery: Deactivated')
	 starteduber = false
	 hasdelivery = true
	 removeblips()
	end
	...
	exports['NRP-notify']:DoHudText('error', 'You Need Atleast 250 Points in SOTW to start delivering for them')
  end
  end
end)
...
Citizen.CreateThread(function()
  while true do
   ...
   if exports['core']:GetItemQuantity(298) >= 10 then
	if(GetDistanceBetweenCoords(pos, 1044.493, -3194.999, -38.158, true) < 1.35) then
	 DrawText3Ds(1044.493, -3194.999, -38.158,'~g~[E]~w~ To Start Delivery')
	  if IsControlJustPressed(0, 38) then
		 TriggerServerEvent('FL_Perks:LevelChecks')
         Wait(100)
         if tostring(job) == 'SOTW' then
          if tonumber(points) >= 250 then
		   TriggerServerEvent('weedrun:check')
		  else
			exports['NRP-notify']:DoHudText('error', 'You Need Atleast 250 Points in SOTW to start delivering for them')
		  end
		end
