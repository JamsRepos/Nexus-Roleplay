Config = {}
Config.RadioKey = 170  --- Default setting is F1
--Config.HandsUpKey = 10  --- Default setting is PAGEUP
Config.HoverHolsterKey = 171--  --- Default setting is F2
...
Config.Anims = {
    ...
    {name = 'lean', data = {type = 'anim', ad = "amb@lo_res_idles@", anim = "world_human_lean_male_foot_up_lo_res_base", prop = 0, proptwo = 0, boneone = nil, bonetwo = nil, body = 33, x = 0.0, y = 0.0, z = 0.0, xa = 0.0, yb = 0.0, zc = 0.0}},
    ...
    {name = 'cart', data = {type = 'scenario', ad = "PROP_HUMAN_BUM_SHOPPING_CART", anim = "", prop = 0, proptwo = 0, boneone = nil, bonetwo = nil, body = 33, x = 0.0, y = 0.0, z = 0.0, xa = 0.0, yb = 0.0, zc = 0.0}},
