...
--Citizen.CreateThread(function()
   ...
   --[[WarMenu.CreateMenu('list', "Emotes")
    WarMenu.CreateSubMenu('anims', 'list', 'Animations')
    WarMenu.CreateSubMenu('walkanims', 'list', 'Walking Animations')
    ...
    WarMenu.CreateSubMenu('sat', 'scens', 'Sitting')
    WarMenu.CreateSubMenu('misc', 'scens', 'Misc')
	WarMenu.CreateSubMenu('walk', 'list', 'Walking Styles')
	WarMenu.CreateSubMenu('new2', 'anims', 'Scenes')
	WarMenu.CreateSubMenu('new', 'scens', 'New')]]--
    ...
    while true do
        ...
        --[[if WarMenu.IsMenuOpened('list') then
            ...
            elseif WarMenu.MenuButton('Walking Animations', 'walkanims') then
            elseif WarMenu.MenuButton('Walking Styles', 'walk') then
            elseif WarMenu.MenuButton('Personal Action', 'actions') then
            elseif WarMenu.MenuButton('Facial Expressions', 'expressions') then
            end
            WarMenu.Display()
        ...
        elseif WarMenu.IsMenuOpened('anims') then
			...
			elseif WarMenu.MenuButton('Scenes', 'new2') then
            end
        ...
        elseif WarMenu.IsMenuOpened('scens') then
			...
			elseif WarMenu.MenuButton('Sitting', 'sat') then
			elseif WarMenu.MenuButton('New', 'new') then
            end
        ...
        elseif WarMenu.IsMenuOpened('walk') then
			if WarMenu.Button('~r~Reset Walking Style') then
...
RegisterCommand("emotes", function(source, args, rawCommand)
 ...
 exports['NRP-notify']:DoLongHudText('inform',  strResult)
end)
...
Citizen.CreateThread(function()
 WarMenu.CreateMenu('actions', 'Actions')
 while true do
  Citizen.Wait(1)
...
local expressions = 
{
    ...
    {name = 'Aiming', mood = 'mood_aiming_1'},
    {name = 'Angry', mood = 'mood_angry_1'},
    {name = 'Drunk', mood = 'mood_drunk_1'},
    {name = 'Happy', mood = 'mood_happy_1'},
    {name = 'Injured', mood = 'mood_injured_1'},
    {name = 'Stressed', mood = 'mood_stressed_1'},
    {name = 'Sulking', mood = 'mood_sulk_1'},
    {name = 'Sleeping', mood = 'mood_sleeping_1'},
}

--[[Citizen.CreateThread(function()
 WarMenu.CreateMenu('expressions', 'Expressions')
 while true do
  Citizen.Wait(1)
