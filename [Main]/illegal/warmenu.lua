...
function getNPC()
 ...
 repeat
  ...
  if canPedBeUsed(ped) and distance < 2.5 and (distanceFrom == nil or distance < distanceFrom) then
...
function ProgressBar(text, time)
 ...
 while progress_bar do
  ...
  drawUI(0.910, 1.375, 1.0, 1.0, 0.55, progress_bar_text, 0, 0, 0, 255, false)
  if progress_time > 0 then
