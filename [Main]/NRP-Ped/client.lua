...
AddEventHandler('carwash:washing', function()
  ...
  FreezeEntityPosition(vehicle, true)
    exports['pogressBar']:drawBar(2500, 'Washing Car', function()
      Wait(500)
      exports['pogressBar']:drawBar(2500, 'Drying Car', function()
        Wait(500)
        exports['pogressBar']:drawBar(2500, 'Polishing Car', function()
