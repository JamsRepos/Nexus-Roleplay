   ...
   Wait(1)
    if WarMenu.IsMenuOpened('waypoints') then
     ...
     elseif WarMenu.Button('City: Macdonald Street') then
       ...
       TriggerServerEvent("core:newcharacter")
       ExecuteCommand('refreshmotels')
     elseif WarMenu.Button('City: Burgershot') then
       WarMenu.CloseMenu()
       DoScreenFadeOut(50)
       TriggerEvent("core:stopSkyCamera")
       TriggerEvent('NRP-Hud:CharacterSpawned')
       FreezeEntityPosition(GetPlayerPed(-1), true)
       Teleport(-1168.479, -895.615, 13.941)
       Wait(3000)
       FreezeEntityPosition(GetPlayerPed(-1), false)
        DoScreenFadeIn(50)
       Wait(1000)
...
local logout = {
 ...
 [5] = {x = 262.810, y = -1002.794, z = -99.008},
 [6] = {x = 349.519, y = -994.818, z = -99.196},
 [7] = {x = 163.412, y = 485.267, z = 133.869},
 [8] = {x = 376.693, y = 407.939, z = 142.125}
} 
