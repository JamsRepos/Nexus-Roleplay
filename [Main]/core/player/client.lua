...
RegisterCommand('tutorial', function(source, args)
    TriggerEvent('core:starttutorial', true)
end, false)

RegisterNetEvent("core:starttutorial")
AddEventHandler("core:starttutorial", function(command)
    ClearFocus()
    local playerPed = GetPlayerPed(-1)
    ...
    if DoesCamExist(cam) then
        ...
        SetEntityCoordsNoOffset(playerPed, 305.42, -587.17, 44.28, false, false, false, true)
        FreezeEntityPosition(playerPed, true)
        SetFocusEntity(playerPed)
        Citizen.Wait(800)
        SetCamCoord(cam, 305.42, -587.17, 44.28)
        RenderScriptCams(1, 0, 0, 1, 1)
        SetCamRot(cam, 0.0, 0.0, 210.28)
        DoScreenFadeIn(800)
        Citizen.Wait(1000)
        ...
        SetEntityCoordsNoOffset(playerPed, 313.88, -590.75, 44.28, false, false, false, true)
        FreezeEntityPosition(playerPed, true)
        SetFocusEntity(playerPed)
        Citizen.Wait(800)
        SetCamCoord(cam, 313.88, -590.75, 44.28)
        RenderScriptCams(1, 0, 0, 1, 1)
        SetCamRot(cam, 0.0, 0.0, 162.85)
        DoScreenFadeIn(800)
        Citizen.Wait(1000)
        ...
        Citizen.Wait(5000)
        Citizen.Wait(1000)
        exports['NRP-notify']:DoCustomHudText('inform', 'Is your friend down and no EMS on? Emergency Medkits will give you a 50/50 chance at getting your buddy up!', 6000, { ['text-align'] = 'center', ['background-color'] = '#2a9946', ['color'] = '#000000' })
        Citizen.Wait(6000)
        Citizen.Wait(1000)
        DoScreenFadeOut(800)
        Citizen.Wait(3000)
        ...
        if not command then
            SetEntityCoordsNoOffset(playerPed, -220.744, -1053.473, 29.540, false, false, false, true)
        else
