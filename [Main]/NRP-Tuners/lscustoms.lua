...
local garages = { 
	[1] = {locked = false, camera = {x = -222.792, y = -1328.336, z = 32.390, heading = 247.092}, driveout = {x = -222.855, y = -1329.876, z = 30.890, heading = 91.845}, drivein = {x = -222.855, y = -1329.876, z = 30.890, heading = 91.845}, outside = {x = -222.855, y = -1329.876, z = 30.890, heading = 91.845}, inside = {x = -222.855, y = -1329.876, z = 30.890, heading = 91.845}},
	[2] = {locked = false, camera = {x = 735.772, y = -1072.646, z = 22.233, heading = 357.165}, driveout = {x = 735.772, y = -1072.646, z = 22.233, heading = 357.165}, drivein = {x = 735.772, y = -1072.646, z = 22.233, heading = 357.165}, outside = {x = 735.772, y = -1072.646, z = 22.233, heading = 357.165}, inside = {x = 735.772, y = -1072.646, z = 22.233, heading = 357.165}},
	[3] = {locked = false, camera = {x = 1182.719, y = 2638.211, z = 37.795, heading = 182.761}, driveout = {x = 1182.719, y = 2638.211, z = 37.795, heading = 182.761}, drivein = {x = 1182.719, y = 2638.211, z = 37.795, heading = 182.761}, outside = {x = 1182.719, y = 2638.211, z = 37.795, heading = 182.761}, inside = {x = 1182.719, y = 2638.211, z = 37.795, heading = 182.761}},
	[4] = {locked = false, camera = {x = -326.565, y = -137.222, z = 39.010, heading = 257.013}, driveout = {x = -326.565, y = -137.222, z = 39.010, heading = 257.013}, drivein = {x = -326.565, y = -137.222, z = 39.010, heading = 257.013}, outside = {x = -326.565, y = -137.222, z = 39.010, heading = 257.013}, inside = {x = -326.565, y = -137.222, z = 39.010, heading = 257.013}},
	[5] = {locked = false, camera = {x = 1226.806, y = -1103.980, z = 38.662, heading = 257.013}, driveout = {x = 1226.806, y = -1103.980, z = 38.662, heading = 213.67}, drivein = {x = 1226.806, y = -1103.980, z = 38.662, heading = 257.013}, outside = {x = 1226.806, y = -1103.980, z = 38.662, heading = 257.013}, inside = {x = 1226.806, y = -1103.980, z = 38.662, heading = 257.013}},

	[6] = {locked = false, camera = {x = 2228.82, y = 2923.15, z = 50.45, heading = 224.56}, driveout = {x = 2231.46, y = 2920.18, z = 47.52, heading = 1.86}, drivein = {x = 2231.46, y = 2920.18, z = 47.52, heading = 1.86}, outside = {x = 2231.46, y = 2920.18, z = 47.52, heading = 1.86}, inside = {x = 2231.46, y = 2920.18, z = 47.52, heading = 1.86}},
	[7] = {locked = false, camera = {x = 2230.42, y = 2948.56, z = 47.51, heading = 181.78}, driveout = {x = 2230.42, y = 2948.56, z = 47.51, heading = 181.78}, drivein = {x = 2230.42, y = 2948.56, z = 47.51, heading = 181.78}, outside = {x = 2230.42, y = 2948.56, z = 47.51, heading = 181.78}, inside = {x = 2230.42, y = 2948.56, z = 47.51, heading = 181.78}},
}
	...
	if (GetNumVehicleMods(veh,mod) ~= nil and GetNumVehicleMods(veh,mod) > 0) or mod == 18 or mod == 22 or mod == 50 or (GetVehicleLiveryCount(veh) ~= nil and GetVehicleLiveryCount(veh) > 0) then
		...
		if LSC_Config.prices.mods[mod].startprice then
			...
			for n, v in pairs(LSC_Config.prices.mods[mod]) do
				btn = m:addPurchase(v.name,math.floor(v.price))btn.modtype = mod
				btn.mod = v.mod
			end
		end
	end
...
local function DriveInGarage()
	...
	if DoesEntityExist(veh) then
		...
		LSCMenu:addPurchase("Repair Vehicle",round(repairprice[GetVehicleClass(veh)]*damage+enginedamage*2,0), "Full body repair and engine service.")
		...
		for n, mod in pairs(LSC_Config.prices.plates) do
			local btn = LSCMenu.categories.Plates.License:addPurchase(mod.name,math.floor(mod.price))btn.plateindex = mod.plateindex
		end
			...
			m = m:addSubMenu("NEON KITS", "Neon kits", nil, true)
				m:addSubMenu("NEON LAYOUT", "Neon layout", nil, true)
					...
					for n, mod in pairs(LSC_Config.prices.neonlayout) do
						local btn = m["Neon layout"]:addPurchase(mod.name,math.floor(mod.price))
					end
			
			m = m:addSubMenu("NEON COLOR", "Neon color", nil, true)
				for n, mod in pairs(LSC_Config.prices.neoncolor) do
					local btn = m:addPurchase(mod.name,math.floor(mod.price))btn.neon = mod.neon
				end
		end
		...
		respray = LSCMenu.categories:addSubMenu("RESPRAY", "Respray", "Transforms vehicle appearance.",true)
			pcol = respray:addSubMenu("PRIMARY COLORS", "Primary color",  nil,true)
				...
				for n, c in pairs(LSC_Config.prices.chrome.colors) do
					local btn = pcol.Chrome:addPurchase(c.name,math.floor(LSC_Config.prices.chrome.price))btn.colorindex = c.colorindex
				...
				for n, c in pairs(LSC_Config.prices.classic.colors) do
					local btn = pcol.Classic:addPurchase(c.name,math.floor(LSC_Config.prices.classic.price))btn.colorindex = c.colorindex
					if btn.colorindex == myveh.color[1] then
						btn.purchased = true
					end
				end
				...
				for n, c in pairs(LSC_Config.prices.matte.colors) do
					local btn = pcol.Matte:addPurchase(c.name,math.floor(LSC_Config.prices.matte.price))btn.colorindex = c.colorindex
					if btn.colorindex == myveh.color[1] then
						btn.purchased = true
					end
				end
				...
				for n, c in pairs(LSC_Config.prices.metallic.colors) do
					local btn = pcol.Metallic:addPurchase(c.name,math.floor(LSC_Config.prices.metallic.price))btn.colorindex = c.colorindex
				...
				for n, c in pairs(LSC_Config.prices.metal.colors) do
					local btn = pcol.Metals:addPurchase(c.name,math.floor(LSC_Config.prices.metal.price))btn.colorindex = c.colorindex
					if btn.colorindex == myveh.color[1] then
						btn.purchased = true
					end
				end
			scol = respray:addSubMenu("SECONDARY COLORS", "Secondary color", nil,true)
				...
				for n, c in pairs(LSC_Config.prices.chrome2.colors) do
					local btn = scol.Chrome:addPurchase(c.name,math.floor(LSC_Config.prices.chrome2.price))btn.colorindex = c.colorindex
				...
				for n, c in pairs(LSC_Config.prices.classic2.colors) do
					local btn = scol.Classic:addPurchase(c.name,math.floor(LSC_Config.prices.classic2.price))btn.colorindex = c.colorindex
					if btn.colorindex == myveh.color[2] then
						btn.purchased = true
					end
				end
				...
				if IsThisModelABike(GetEntityModel(veh)) then
					fwheels = wtype:addSubMenu("FRONT WHEEL", "Front wheel", nil,true)
						for n, w in pairs(LSC_Config.prices.frontwheel) do
							btn = fwheels:addPurchase(w.name,math.floor(w.price))btn.wtype = w.wtype btn.modtype = 23 btn.mod = w.mod
						end
					bwheels = wtype:addSubMenu("BACK WHEEL", "Back wheel", nil,true)
						for n, w in pairs(LSC_Config.prices.backwheel) do
							btn = bwheels:addPurchase(w.name,math.floor(w.price))btn.wtype = w.wtype btn.modtype = 24 btn.mod = w.mod
						end
				else
					sportw = wtype:addSubMenu("SPORT WHEELS", "Sport", nil,true)
						for n, w in pairs(LSC_Config.prices.sportwheels) do
							local btn = sportw:addPurchase(w.name,math.floor(w.price))btn.wtype = w.wtype btn.modtype = 23 btn.mod = w.mod
						end
					musclew = wtype:addSubMenu("MUSCLE WHEELS", "Muscle", nil,true)
						for n, w in pairs(LSC_Config.prices.musclewheels) do
							local btn = musclew:addPurchase(w.name,math.floor(w.price))btn.wtype =  w.wtype btn.modtype = 23 btn.mod = w.mod
						end
					lowriderw = wtype:addSubMenu("LOWRIDER WHEELS", "Lowrider", nil,true)
						for n, w in pairs(LSC_Config.prices.lowriderwheels) do
							local btn = lowriderw:addPurchase(w.name,math.floor(w.price))btn.wtype =  w.wtype btn.modtype = 23 btn.mod = w.mod
						end
					suvw = wtype:addSubMenu("SUV WHEELS", "Suv", nil,true)
						for n, w in pairs(LSC_Config.prices.suvwheels) do
							local btn = suvw:addPurchase(w.name,math.floor(w.price))btn.wtype = w.wtype btn.modtype = 23 btn.mod = w.mod
						end
					offroadw = wtype:addSubMenu("OFFROAD WHEELS", "Offroad", nil,true)
						for n, w in pairs(LSC_Config.prices.offroadwheels) do
							local btn = offroadw:addPurchase(w.name,math.floor(w.price))btn.wtype = w.wtype btn.modtype = 23 btn.mod = w.mod
						end
					tunerw = wtype:addSubMenu("TUNER WHEELS", "Tuner", nil,true)
						for n, w in pairs(LSC_Config.prices.tunerwheels) do
							local btn = tunerw:addPurchase(w.name,math.floor(w.price))btn.wtype = w.wtype btn.modtype = 23 btn.mod = w.mod
						end
					hughendw = wtype:addSubMenu("HIGHEND WHEELS", "Highend", nil,true)
						for n, w in pairs(LSC_Config.prices.highendwheels) do
							local btn = hughendw:addPurchase(w.name,math.floor(w.price))btn.wtype = w.wtype btn.modtype = 23 btn.mod = w.mod
						end
				end
		...
		m = LSCMenu.categories.Wheels:addSubMenu("WHEEL COLOR", "Wheel color", "Custom wheel colors.",true)
			for n, c in pairs(LSC_Config.prices.wheelcolor.colors) do
				local btn = m:addPurchase(c.name,math.floor(LSC_Config.prices.wheelcolor.price))btn.colorindex = c.colorindex
			end
		...
		m = LSCMenu.categories.Wheels:addSubMenu("WHEEL ACCESSORIES", "Wheel accessories", "Bulletproof tires and custom burnout smoke.",true)
			for n, mod in pairs(LSC_Config.prices.wheelaccessories) do
				local btn = m:addPurchase(mod.name,math.floor(mod.price))btn.smokecolor = mod.smokecolor
			end
		...
		m = LSCMenu.categories:addSubMenu("WINDOWS", "Windows", "A selection of tinted windows.",true)	
			...
			for n, tint in pairs(LSC_Config.prices.windowtint) do
				btn = m:addPurchase(tint.name,math.floor(tint.price))btn.tint = tint.tint
			end
...
local function DriveOutOfGarage(pos)
	Citizen.CreateThread(function()
		...
		TriggerServerEvent("LSC:finished2", plate, vehProps)
							 ...
							 if DecorGetInt(GetPlayerPed(-1), "Job") == 3 then
								...
								if not LSC_Config.lock then
									if IsControlJustPressed(1,201) then
										...
										drawTxt("~g~[ENTER]~w~ Enter Tuner Shop")
									end
								else
								...
								if IsControlJustPressed(1,201) then
									...
									drawTxt("~r~Contact a Mechanic for Further Upgrades")
								end
							end
						end
					end
...
function LSCMenu:onSelectedIndexChanged(name, button)
	...
	elseif m == "additional liveries" then
		SetVehicleLivery(veh, button.mod)
	else
	end
	if m == "horn" then
...
function LSCMenu:onButtonSelected(name, button)
	TriggerServerEvent("LSC:buttonSelected2", name, button, garageID)
end

RegisterNetEvent("LSC:buttonSelected2")
AddEventHandler("LSC:buttonSelected2", function(name, button, canpurchase)
	name = name:lower()
	local m = LSCMenu.currentmenu
	local price = button.price or 0
	local veh = myveh.vehicle
...
AddEventHandler('lockGarage2', function(tbl)
