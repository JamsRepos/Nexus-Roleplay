...
AddEventHandler('customs:updatevat', function(price, id)
 ...
 TriggerEvent('core:getPlayerFromId', source, function(user)
  ...
  TriggerClientEvent('NRP-notify:client:SendAlert', tonumber(source), { type = 'inform', text = "Vat Price Updated",timeout = 2500,layout = "centerRight"})
  TriggerEvent('customs:update')
 end)
end)
...
AddEventHandler('customs:takeBank', function(bank, id)
 ...
 TriggerEvent('core:getPlayerFromId', source, function(user)
  ...
  TriggerClientEvent('NRP-notify:client:SendAlert', tonumber(source), { type = 'inform', text = "Bank Deposited Into Your Account",timeout = 2500,layout = "centerRight"})
  user.addBank(bank)
  TriggerEvent('customs:update')
 end)
end)
