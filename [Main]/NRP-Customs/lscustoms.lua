...
local function DriveInGarage()
	...
	if DoesEntityExist(veh) then
		...
		LSCMenu:addPurchase("Repair Vehicle",round(repairprice[GetVehicleClass(veh)]*damage+enginedamage*2+customsVat,0), "Full body repair and engine service.")
					...
					for i,pos in ipairs(garages) do
						...
						if LSC_Config.oldenter then			
							if GetDistanceBetweenCoords(outside.x,outside.y,outside.z,GetEntityCoords(ped)) <= f(5) then
							  if not tableContains(LSC_Config.ModelBlacklist,GetDisplayNameFromVehicleModel(GetEntityModel(veh)):lower()) and exports['core']:HasKey(GetVehicleNumberPlateText(veh)) then
									if pos.locked then
										if not LSC_Config.lock then
											if IsControlJustPressed(1,201) then
												...
												drawTxt("~m~Press ~g~ENTER~m~ To Enter ~g~Los Santos Customs")
											end
										else
							...
							elseif not tableContains(LSC_Config.ModelBlacklist,GetDisplayNameFromVehicleModel(GetEntityModel(veh)):lower()) and DecorGetInt(GetPlayerPed(-1), "Job") == 1 or DecorGetInt(GetPlayerPed(-1), "Job") == 18 or DecorGetInt(GetPlayerPed(-1), "Job") == 32 or DecorGetInt(GetPlayerPed(-1), "Job") == 33 or DecorGetInt(GetPlayerPed(-1), "Job") == 34 or DecorGetInt(GetPlayerPed(-1), "Job") == 35 or DecorGetInt(GetPlayerPed(-1), "Job") == 36 or DecorGetInt(GetPlayerPed(-1), "Job") == 37 or DecorGetInt(GetPlayerPed(-1), "Job") == 90 or DecorGetInt(GetPlayerPed(-1), "Job") == 91 then
								if pos.locked then
								if not LSC_Config.lock then
									if IsControlJustPressed(1,201) then
										inside = true
								...
								if IsControlJustPressed(1,201) then
									...
									if ownedCustoms[pos.id] then 
										customsVat = ownedCustoms[pos.id].vat
									 print('Vat: $'..ownedCustoms[pos.id].vat)
									end
									DriveInGarage()
								else
									drawTxt("~m~Press ~g~ENTER~m~ To Enter ~g~Los Santos Customs")
 ...
 while true do
    ...
    if (GetDistanceBetweenCoords(GetEntityCoords(GetPlayerPed(-1)), pos.x, pos.y, pos.z, true) < 25) then
     ...
     if(GetDistanceBetweenCoords(GetEntityCoords(GetPlayerPed(-1)), pos.x, pos.y, pos.z, true) < 1.5) then
      if ownedCustoms[v.id] then
       if ownedCustoms[v.id].owner == myCharacterID then 
        drawTxt('~m~Press ~g~E ~m~Manage Customs')
       ...
       drawTxt('~m~Press ~g~E ~m~Purchase Los Santos Customs\n~w~[~g~$'..v.price*exports['core']:getVat(5).."~w~]")
       if IsControlJustPressed(0, 38) then
       	TriggerServerEvent('customs:purchase', i, v.price*exports['core']:getVat(5))
       end
      end
     end
    end
  ...
  if WarMenu.IsMenuOpened('manage_fuelstation') then
   ...
   elseif WarMenu.Button('Bank', '~g~$'..currentStation.bank) then
    ...
    WarMenu.CloseMenu()
   elseif WarMenu.Button('Station Price', '~g~$'..currentStation.price) then
   	TriggerServerEvent('customs:sell', currentStation.id)
   end
   WarMenu.Display()
  end
 end
