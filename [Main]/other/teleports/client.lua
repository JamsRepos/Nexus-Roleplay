local locations = {
    ...
    [40] = {name = 'The Firing Range', enter = {x = 459.596, y = -988.909, z = 30.689-0.97}, exit = {x = 902.787, y = -3182.665, z = -97.053-0.97}},
    [42] = {name = 'Money Wash', enter = {x = -191.35, y = -1179.23, z = 23.08-0.95}, exit = {x = 1138.056, y = -3198.634, z = -39.666-0.95}},
